...
func WithGatewayTimeout(timeout time.Duration) Option {
	return func(a *App) {
		a.gatewayTimeout = timeout
	}
}
...
func New(log *slog.Logger, opts ...Option) *App {
	app := &App{
		...
		gatewayTimeout: srvGatewayTimeoutDefault,
	}
...
func (a *App) Run(ctx context.Context) error {
	...
	fapp.Get("/test", timeout.NewWithContext(testHandle, a.gatewayTimeout))
